/*$Id: snmpset.src,v 1.3.2.5 2012/01/09 14:33:54 sumathi.g Exp $*/
/*
 * @(#)snmpset.java
...
public class snmpset {
    ...
    String usage = "snmpset [-v version(v1,v2,v3)] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol(MD5/SHA)] [-w auth_password] [-s priv_password] [-d debug] [-n contextName ] [ -i contextID ] [ -pp priv_protocol (DES/AES-128/AES-192/AES-256/3DES) ] -m MIB_files host OID value [OID value] ...";
