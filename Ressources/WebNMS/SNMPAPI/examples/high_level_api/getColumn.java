/*$Id: getColumn.src,v 1.3.2.6 2012/01/09 14:23:06 sumathi.g Exp $*/
/*
 * @(#)getColumn.java
 ...
 *  components.This can be used to get a column from a table if the column
 *  name is known. 
 *
 ...
 * columnName          - Name of the column in the table. Mandatory.
...
public class getColumn {
    ...
    String usage = "getColumn [-v version(v1,v2,v3)] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol(MD5/SHA)] [-w auth_password] [-s priv_password] [-n contextname] [-i contextID] [-d debug] [ -pp priv_protocol (DES/AES-128/AES-192/AES-256/3DES) ] host columnName MIB_files";
 ...
 if(values[VERSION] != null)
  ...
  if ((values[VERSION].equals("v3")) && (values[USER_NAME] == null)) opt.usage_error();
    ...
    String[] result=table.getColumn(opt.remArgs[1]);
    if(result!=null)
