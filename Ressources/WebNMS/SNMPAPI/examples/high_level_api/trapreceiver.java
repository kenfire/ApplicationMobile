 /* $Id: trapreceiver.src,v 1.4.4.9 2012/01/09 14:35:17 sumathi.g Exp $ */
 /*
 * @(#)trapreceiver.java
 ...
 * [-p] <port>         - local port no. By default 162.
 ...
 * [-s] <privPassword> - The privacy protocol password. Must be accompanied with authPassword and authProtocol fields.
 * [-n] <contextName>  - The snmpv3 contextName to be used.
 * [-i] <contextID>    - The snmpv3 contextID to be used.
 * [-pp] <privProtocol> - The privacy protocol. Must be accompanied with authPassword, privPassword and authProtocol fields.
 */
