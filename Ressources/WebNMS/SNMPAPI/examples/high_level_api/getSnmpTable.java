/*$Id: getSnmpTable.src,v 1.3.2.6 2012/01/09 14:25:01 sumathi.g Exp $*/
/*
 * @(#)getSnmpTable.java
...
public class getSnmpTable implements SnmpTableListener {
    ...
    String usage = "getSnmpTable [-v version(v1,v2,v3)] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol(MD5/SHA)] [-w auth_password] [-s priv_password] [-n contextname] [-i contextID] [-d debug] [ -pp priv_protocol (DES/AES-128/AES-192/AES-256/3DES) ] host tableOID MIB_files";
